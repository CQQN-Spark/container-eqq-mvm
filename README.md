...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-eqq-mvm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-eqq-mvm.containers.anotherwebservice.com/
...
```
git clone git@github.com:CQQN-Spark/container-eqq-mvm.git
cd container-eqq-mvm
```
...
```
docker attach container-eqq-mvm
```
